...
```{r, echo=FALSE}
require(knitr)
opts_knit$set(root.dir = "/Users/sambuckberry/Desktop/Dropbox/PhD/R_Projects/RUN-WGCNA/")
```
...
```
<img src="https://github.com/SamBuckberry/RUN-WGCNA/blob/master/plots/modClusterPlot.pdf" style="width: 800px;"/>
